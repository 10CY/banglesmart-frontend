...
<div style="max-width:620px;margin:30px auto;background:#fff;border:1px solid #e8e0d4;border-radius:18px;overflow:hidden;">
    ...
    <div style="padding:32px;">
        ...
        <h1 style="font-size:28px;margin:18px 0 10px;">Thank you, <?php echo e($order->user?->name ?? 'Customer'); ?>!</h1>
        <p style="color:#666;line-height:1.7;">Your order <strong><?php echo e($order->order_number); ?></strong> has been received successfully. Your invoice is attached to this email.</p>
        <div style="margin:24px 0;padding:18px;background:#fbfaf7;border:1px solid #eee6da;border-radius:14px;">
            ...
            <div style="margin-top:6px;font-size:24px;font-weight:700;">₹<?php echo e(number_format((float)$order->total_amount, 2)); ?></div>
        </div>
        ...
        <a href="<?php echo e(rtrim(config('app.url'), '/')); ?>/account/orders/<?php echo e($order->id); ?>" style="display:inline-block;margin-top:10px;padding:13px 22px;border-radius:999px;background:#111827;color:#fff;text-decoration:none;font-size:14px;font-weight:600;">View My Order</a>
    </div>
...
<?php /**PATH C:\xampp\htdocs\banglesmart_final\backend\resources\views\emails\order-confirmation.blade.php ENDPATH**/ ?>